...
const translations: Translations = {
  ...
  "analytics.subtitle": {
    en: "Track your course performance and student engagement",
    vi: "Theo dõi hiệu suất khóa học và tương tác học viên",
  },
  ...
  "analytics.revenueTrend": {
    en: "Revenue & Enrollments Trend",
    vi: "Xu hướng Doanh thu & Đăng ký",
  },
  "analytics.coursePerformance": {
    en: "Course Performance",
    vi: "Hiệu suất Khóa học",
  },
  "analytics.trafficSources": { en: "Traffic Sources", vi: "Nguồn truy cập" },
  "analytics.studentEngagement": {
    en: "Weekly Student Engagement",
    vi: "Tương tác học viên hàng tuần",
  },
  "analytics.topLessons": {
    en: "Top Performing Lessons",
    vi: "Bài học nổi bật",
  },
  "analytics.studentGeography": {
    en: "Student Geography",
    vi: "Phân bố học viên",
  },
  ...
  "courses.subtitle": {
    en: "Manage your course content and students",
    vi: "Quản lý nội dung khóa học và học viên",
  },
  ...
  "courses.makePublic": {
    en: "Make this course public",
    vi: "Công khai khóa học này",
  },
  "courses.enableQA": { en: "Enable Q&A", vi: "Bật Hỏi & Đáp" },
  "courses.allowQuestions": {
    en: "Allow students to ask questions",
    vi: "Cho phép học viên đặt câu hỏi",
  },
  "courses.enableReviews": { en: "Course Reviews", vi: "Đánh giá khóa học" },
  "courses.allowReviews": {
    en: "Allow students to leave reviews",
    vi: "Cho phép học viên để lại đánh giá",
  },
  "courses.saveChanges": { en: "Save Changes", vi: "Lưu thay đổi" },
  "courses.enrolledStudents": {
    en: "Enrolled Students",
    vi: "Học viên đã đăng ký",
  },
  "courses.studentQuestions": {
    en: "Student Questions",
    vi: "Câu hỏi của học viên",
  },
  ...
  "settings.subtitle": {
    ...
    vi: "Quản lý tài khoản và tùy chọn",
  },
  ...
  "settings.newLessonDesc": {
    en: "Get notified when new lessons are published",
    vi: "Nhận thông báo khi bài học mới được xuất bản",
  },
  "settings.forumReplies": { en: "Forum replies", vi: "Trả lời diễn đàn" },
  "settings.forumRepliesDesc": {
    en: "Receive notifications for forum activity",
    vi: "Nhận thông báo về hoạt động diễn đàn",
  },
  "settings.achievements": {
    en: "Achievement unlocked",
    vi: "Thành tựu mở khóa",
  },
  "settings.achievementsDesc": {
    en: "Get notified when you earn badges",
    vi: "Nhận thông báo khi bạn nhận huy hiệu",
  },
  "settings.weeklyReport": {
    en: "Weekly progress summary",
    vi: "Báo cáo tiến độ hàng tuần",
  },
  "settings.weeklyReportDesc": {
    en: "Receive a weekly email with your progress",
    vi: "Nhận email hàng tuần về tiến độ của bạn",
  },
  "settings.marketing": { en: "Marketing emails", vi: "Email quảng cáo" },
  "settings.marketingDesc": {
    en: "Receive updates about new features and promotions",
    vi: "Nhận thông tin về tính năng mới và khuyến mãi",
  },
  ...
  "settings.dailyReminderDesc": {
    en: "Remind me to practice coding daily",
    vi: "Nhắc tôi luyện tập code hàng ngày",
  },
  "settings.streakAlerts": { en: "Streak alerts", vi: "Cảnh báo chuỗi ngày" },
  "settings.streakAlertsDesc": {
    en: "Alert when my streak is about to break",
    vi: "Cảnh báo khi chuỗi ngày sắp bị phá vỡ",
  },
  ...
  "settings.enable2FADesc": {
    en: "Add an extra layer of security to your account",
    vi: "Thêm lớp bảo mật cho tài khoản của bạn",
  },
  ...
  "settings.darkModeActive": {
    en: "Dark Mode Active",
    vi: "Chế độ tối đang bật",
  },
  "settings.codeTheme": {
    en: "Code Editor Theme",
    vi: "Giao diện trình soạn thảo",
  },
  ...
  "nav.quizManager": { en: "Quiz Manager", vi: "Quản lý Quiz" },
