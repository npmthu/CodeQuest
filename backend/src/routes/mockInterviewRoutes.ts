...
router.get('/my-bookings', supabaseAuth, interviewController.getMyBookings.bind(interviewController));
...
// Feedback Routes
router.post('/feedback', supabaseAuth, feedbackController.createFeedback.bind(feedbackController));
router.get('/my-feedback', supabaseAuth, feedbackController.getMyFeedback.bind(feedbackController));
router.get('/feedback/:id', supabaseAuth, feedbackController.getFeedbackById.bind(feedbackController));
router.put('/feedback/:id', supabaseAuth, feedbackController.updateFeedback.bind(feedbackController));
router.get('/instructor-feedback-stats', supabaseAuth, feedbackController.getInstructorFeedbackStats.bind(feedbackController));

// AI Assistance Routes
router.post('/ai/suggest-topics', supabaseAuth, aiController.suggestTopics.bind(aiController));
router.post('/ai/summary', supabaseAuth, aiController.generateSummary.bind(aiController));
router.post('/ai/mindmap', supabaseAuth, aiController.generateMindmap.bind(aiController));
router.post('/ai/hint', supabaseAuth, aiController.generateHint.bind(aiController));
router.post('/ai/code-review', supabaseAuth, aiController.reviewCode.bind(aiController));
router.get('/ai/usage-stats', supabaseAuth, aiController.getAIUsageStats.bind(aiController));
