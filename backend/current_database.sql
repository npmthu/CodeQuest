...
CREATE TABLE public.courses (
  ...
  CONSTRAINT courses_partner_id_fkey FOREIGN KEY (partner_id) REFERENCES public.partners(user_id)
);
...
CREATE TABLE public.instructors (
  ...
  CONSTRAINT instructors_partner_id_fkey FOREIGN KEY (partner_id) REFERENCES public.partners(user_id),
