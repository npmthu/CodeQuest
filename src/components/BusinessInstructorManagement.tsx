...
export default function BusinessInstructorManagement({ onNavigate }: BusinessInstructorManagementProps) {
  ...
  const performanceData = [
    ...
    { name: "Prof. Michael Johnson", students: 198, rating: 4.8, completion: 88 },
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="e.g., Machine Learning, Web Development" />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="Brief introduction about the instructor" />
              </div>
            </div>
            <DialogFooter>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          {instructors.map((instructor) => (
            <Card key={instructor.id} className="p-6 hover:shadow-lg transition-all">
              <div className="flex items-start gap-6">
                <div className="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                  <span className="text-xl text-blue-600">{instructor.avatar}</span>
                </div>
            ...
            <div key={idx} className="p-4 bg-gray-50 rounded-lg">
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {assignment.learners} learners • Avg. Rating: {assignment.avgRating}
                  </p>
                </div>
